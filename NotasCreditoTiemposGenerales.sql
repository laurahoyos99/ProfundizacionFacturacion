...
NOTASCREDITO AS(
SELECT DISTINCT CONTRATO, FECHA_APERTURA, FECHA_FINALIZACION
...
ROUND(AVG(DATE_DIFF(FECHA_FINALIZACION,FECHA_APERTURA,DAY)),2) AS Tiempo_Solucion,
COUNT(DISTINCT CONTRATO) AS Registros
FROM NOTASCREDITO
WHERE FECHA_FINALIZACION>FECHA_APERTURA
