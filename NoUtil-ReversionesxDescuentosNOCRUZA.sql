-PRUEBA PARA VER QUE REVERSIONES Y DESCUENTOS NO CRUZA
WITH  
...
WHERE MOTIVO = "REVERSION AUTOMATICA"
...
SELECT DISTINCT c.TIQUETE_ID, c.Numero_Tiquete, c.ContratoR, c.FechaRever, c.FechaDescuento
FROM CRUCE c
