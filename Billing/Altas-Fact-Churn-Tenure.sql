/*ALTAS - FACTURACIÓN - CHURN para rangos TENURE*/
WITH 
...
WHERE DATE_DIFF(f.FechaFact,a.FechaAltas,DAY)<=210 AND f.FechaFact>a.FechaAltas
AND DATE_DIFF(f.FechaFact,a.FechaAltas,DAY)>=180
