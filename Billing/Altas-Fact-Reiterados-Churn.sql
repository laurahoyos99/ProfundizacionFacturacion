...
INNER JOIN REITERADOS r on r.contratos2 = h.NOMBRE_CONTRATO
...
AND h.FECHA_FINALIZACION > r.FechaFact2  AND DATE_DIFF ( h.FECHA_FINALIZACION, r.FechaFact2, DAY) <= 60
GROUP BY h.NOMBRE_CONTRATO, h.FECHA_APERTURA, h.FECHA_FINALIZACION),

CHURNFLAGRESULT AS(
SELECT DISTINCT r.Contratos2, r.FechaFact2,r.FechaAltas2,h.FechaChurn,r.contratos1, r.FechaFact1, ReiterFlag,
CASE WHEN h.FechaChurn IS NOT NULL THEN "Churner"
WHEN h.FechaChurn IS NULL THEN "NonChurner" end as ChurnFlag
FROM REITERADOS r LEFT JOIN CHURNERS h ON r.contratos2 = h.NOMBRE_CONTRATO
GROUP BY r.Contratos2, r.FechaFact2,r.FechaAltas2,h.FechaChurn, r.contratos1, r.FechaFact1, ReiterFlag)

SELECT 
--DISTINCT t.Contratos2, t.FechaFact2,t.FechaAltas2,t.FechaChurn,t.contratos1, t.FechaFact1, t.ReiterFlag
COUNT(DISTINCT t.Contratos2) as Reg, EXTRACT (Month FROM t.FechaAltas2) as Mes
FROM CHURNFLAGRESULT t 
WHERE ReiterFlag ="Nuevos"
--WHERE ReiterFlag ="Reiterados"
--AND ChurnFlag="Churner"
AND ChurnFlag="NonChurner"
--GROUP BY t.Contratos2, t.FechaFact2,t.FechaAltas2,t.FechaChurn,t.contratos1, t.FechaFact1, t.ReiterFlag
